                                        ...
                                        <div class="row" style="margin-top: 10px">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input  readonly type="text" id="agama"  value={{$datams->agama}} class="form-control" name="agama" placeholder="Agama" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2 col-form-label">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input  readonly type="text" id="nama"  value={{$datams->nama}} class="form-control" name="nama" placeholder="Nama" />
                                                    </div>
                                                    <div class="col-md-2">
