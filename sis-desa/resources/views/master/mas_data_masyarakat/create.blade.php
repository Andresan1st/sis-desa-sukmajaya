                                            ...
                                            <div class="row" style="margin-top: 10px">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="number"  id="nik" class="form-control" name="nik" placeholder="NIK" />
                                                        </div>
                                                        <div class="col-md-2 col-form-label">
                                                            <label class="font-weight-bolder">Agama</label></label>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="text" id="agama" class="form-control" name="agama" placeholder="Agama" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-md-2 col-form-label">
...
@section('script')
    <script>
        ...
        function save() {
            ...
            $.ajax({
                url: "<?php echo url('/mas_data_masyarakat/store'); ?>",
                type: "POST",
                data: dataarray,
                dataType: "JSON",
