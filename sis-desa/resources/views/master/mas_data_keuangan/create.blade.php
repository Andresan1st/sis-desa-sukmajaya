                                            ...
                                            <div class="row" style="margin-top: 10px">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" id="tanggal" name="tanggal" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" id="total_keuangan" class="form-control numeric" onkeyup=""   value="0" name="total_keuangan" required>
                                                        </div>
                                                    </div>
...
@section('script')
    <script>
        ...
        function save() {
            ...
            $.ajax({
                url: "<?php echo url('/mas_data_keuangan/store'); ?>",
                type: "POST",
                data: dataarray,
                dataType: "JSON",
