                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form id="formdata" class="form form-horizontal">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <input type="text" id="id" value="{{$datauser->id}}" class="form-control" name="id" hidden placeholder="Nama Jabatan" />
                                        ...
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4 controls">
                                                    <input type="text" id="name"  value="{{$datauser->username}}"  class="form-control" name="name"  autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-4 controls">
                                                    <input type="email" id="email"  value="{{$datauser->email}}"  class="form-control" name="email" data-validation-required-message="Harus Format Email!"  autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-4 controls">
                                                    <select class="select2 form-control" id="role"  name="role" required>
                                                        @foreach ($department as $data)
                                                             <option @if(strtolower($data->nama_jabatan) == $datauser->role) selected @endif value="{{ $data->nama_jabatan }}">{{$data->nama_jabatan}}</option>
                                                         @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4 controls">
                                                    <select class="select2 form-control" id="id_pegawai"  name="id_pegawai" required>
                                                        ...
                                                        <option @if($data->id == $datauser->id_pegawai) selected @endif value="{{ $data->id }}">{{$data->nama}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            var dataupdate = {!! json_encode($datauser) !!};
        ...
        function save() {
            ...
            $.ajax({
                url: "<?php echo url('/mas_data_userrole/update');?>"+"/"+$("#id").val(),
                type: "POST",
                data: dataarray,
                dataType: "JSON",
