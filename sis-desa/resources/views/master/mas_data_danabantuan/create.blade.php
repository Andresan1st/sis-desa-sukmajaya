                                            ...
                                            <div class="row" style="margin-top: 10px">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" id="tanggal" class="form-control" name="tanggal" placeholder="tanggal" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-md-2 col-form-label">
...
@section('script')
    <script>
        ...
        function save() {
            ...
            $.ajax({
                url: "<?php echo url('/mas_data_bantuan/store'); ?>",
                type: "POST",
                data: dataarray,
                dataType: "JSON",
                    ...
                    if (data.success == "True") {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = "{{ route('mas_data_bantuan') }}";
