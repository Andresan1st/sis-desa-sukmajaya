                                        ...
                                        <div class="row" style="margin-top: 10px">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" disabled value="{{$datoor->nama_organisasi}}"  id="nama_organisasi" class="form-control" name="nama_organisasi" placeholder="Nama Organsisasi" />
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <select disabled   class="select form-control" id="status"  name="status" aria-readonly="true">
...
@section('script')
    <script>
        $(document).ready(function() {
            var dataupdate = {!! json_encode($dataoor) !!};
