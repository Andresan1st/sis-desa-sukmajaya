                                        ...
                                        <div class="row" style="margin-top: 10px">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="nama" class="form-control" value="{{$datapegawai->nama}}" name="nama" placeholder="Nama Pegawai" />
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <textarea class="form-control" id="alamat"  name="alamat"  rows="3" placeholder="Alamat">{{$datapegawai->alamat}}</textarea>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="text" class="form-control phone-number-mask" name="no_telp" value="{{$datapegawai->no_telp}}"  placeholder="62 877 982 577 86" id="no_telp" />
