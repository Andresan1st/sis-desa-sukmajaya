                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="OP_Type" id="OP_Type" value="CASH">
                                                        <label class="form-check-label" for="inlineRadio1">CASH</label>
                                                    </div>
                                                    <div class="form-check form-check-inline col-md-3">
                                                        <input class="form-check-input" type="radio" name="OP_Type" id="OP_Type" value="NON CASH">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="OP_Number" class=" form-control"
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="OP_Date" class=" form-control"
                                                            name="OP_Date">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <div class="input-group">
                                                            <input type="text" id="Sup_Code"name="Sup_Code"style="width: auto;"value=""class="form-control input-sm"  readonly required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <fieldset class="form-group">
                                                            <textarea class="form-control"
                                                                ...
                                                                placeholder="Textarea" readonly></textarea>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="OP_EtdDate" class="js-flatpickr form-control bg-white"
                                                            name="OP_EtdDate">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="OP_EtaDate" class="js-flatpickr form-control bg-white"
                                                            name="OP_EtaDate">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="totalharbar"
                                                            class="form-control numeric" name="totalharbar" value="0" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="total_potong_persen" onkeyup="totalhargaheader()" class="form-control" value="0" name="total_potong_persen"required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="font-weight-bolder">Diskon Nominal <span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-md-2 controls">
                                                        <input type="text" id="total_potong_nominal1" onkeyup="totaldiskonrpheader()" readonly class="form-control numeric" value="0" name="total_potong_nominal1"required>
                                                    </div>
                                                    <div class="col-md-2 controls">
                                                        <input type="text" id="total_potong_nominal2"  onkeyup="totaldiskonrpheader2()" readonly class="form-control numeric" value="0" name="total_potong_nominal2"required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="total_sebelum_ppn"   onkeyup="" class="form-control numeric" value="0" name="total_sebelum_ppn" readonly required>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="total_pajak" onkeyup="totalhargaheader()" class="form-control numeric" value="0" name="total_pajak" required>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="biaya_lain" class="form-control"  name="biaya_lain"required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="font-weight-bolder">Total Biaya Lain </label>
                                                    </div>
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="total_biaya_lain" class="form-control numeric"  onkeyup="totalhargaheader()" value="0" name="total_biaya_lain" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="total_akhir" class="form-control numeric" value="0" name="total_akhir"required>
                                                    </div>
                                                </div>
                                                <br>
                                            </div>
...
@section('script')
    <script>
        ...
        function save() {
            ...
            $.ajax({
                url: "<?php echo url('pcin_tra_purchase_order/store'); ?>",
                type: "POST",
