                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="OP_Type" id="OP_Type1" value="CASH" disabled>
                                                        <label class="form-check-label" for="inlineRadio1">CASH</label>
                                                    </div>
                                                    <div class="form-check form-check-inline col-md-3">
                                                        <input class="form-check-input" type="radio" name="OP_Type" id="OP_Type2" value="NON CASH" disabled>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="OP_Date"  value="{{$datapo->OP_Date}}" class=" form-control"
                                                            name="OP_Date" readonly disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <select class="select2 form-control" id="Cur_Code"  name="Cur_Code" required disabled>
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="OP_Currate" class="form-control" name="OP_Currate" value="1.0" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <div class="input-group">
                                                            <input disabled type="text" id="Sup_Code"name="Sup_Code"style="width: auto;"value="{{$datapo->Sup_Code}}"class="form-control input-sm"  readonly required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <fieldset class="form-group">
                                                            <textarea class="form-control"
                                                                ...
                                                                placeholder="Textarea" readonly disabled>{{$supname}}</textarea>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <fieldset class="form-group">
                                                            <textarea class="form-control"
                                                                ...
                                                                placeholder="Textarea" disabled >{{$datapo->OP_Note}}</textarea>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input type="text" id="totalharbar"
                                                            class="form-control numeric" name="totalharbar" value={{$datapo->OP_Tvalcurr}} disabled required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="total_potong_persen" onkeyup="totalhargaheader()"  class="form-control" value="{{$datapo->OP_PctDisc}}" name="total_potong_persen"required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="font-weight-bolder">Diskon Nominal <span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-md-2 controls">
                                                        <input disabled type="text" id="total_potong_nominal1" onkeyup="totaldiskonrpheader()" readonly class="form-control numeric" value="{{$datapo->OP_ValDisc}}" name="total_potong_nominal1"required>
                                                    </div>
                                                    <div class="col-md-2 controls">
                                                        <input disabled type="text" id="total_potong_nominal2"  onkeyup="totaldiskonrpheader2()" readonly class="form-control numeric" value="{{$datapo->OP_ValDisc}}" name="total_potong_nominal2"required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="number" id="blank4" class="form-control" value="0" name="blank4" hidden required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label  class="font-weight-bolder">Total Sebelum PPn <span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="total_sebelum_ppn"   onkeyup="" class="form-control numeric" value="" name="total_sebelum_ppn" readonly required>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="blank4" class="form-control" value="0" name="blank4" hidden required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="font-weight-bolder">Pajak Pertambahan Nilai <span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="total_pajak" onkeyup="totalhargaheader()" class="form-control numeric" value="{{$datapo->OP_Tvallppn}}" name="total_pajak" required>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="biaya_lain" class="form-control"  name="biaya_lain" value="{{$datapo->OP_Cnote}}"required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="font-weight-bolder">Total Biaya Lain </label>
                                                    </div>
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="total_biaya_lain" class="form-control numeric"  onkeyup="totalhargaheader()" value="{{$datapo->OP_Charges}}" name="total_biaya_lain" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="blank3" class="form-control" value="0" name="blank3" hidden required>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="font-weight-bolder">Total Akhir <span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-md-4 controls">
                                                        <input disabled type="text" id="total_akhir" class="form-control numeric"  name="total_akhir"required>
                                                    </div>
                                                </div>
                                                <br>
                                            </div>
                                                                ...
                                                                <div class="row" style="margin-top: 10px">
                                                                    <div class="col-12">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <div class="input-group">
                                                                                    <input disabled type="text" id="pp_number" name="pp_number"style="width: auto;"value=""class="form-control input-sm" required>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <input  disabled type="text" id="PP_DateDetail" class=" form-control"
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="text" id="OP_DueDateDetail" class="js-flatpickr form-control bg-white"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="text" id="Inv_Code" class="form-control" name="Inv_Code" required readonly>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <label class="font-weight-bolder">Item Name<span class="required">*</span></label>
                                                                            </div>
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="text" id="Inv_Name" class="form-control" name="Inv_Name" required readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <div class="col-md-2">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="number" id="qty"
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <input disabled type="text" id="Harga" class="form-control numeric" onkeyup="hargakeyup()"  value="0" name="Harga" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="text" id="blank2" class="form-control" name="blank2" required hidden >
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <label class="font-weight-bolder">Diskon %<span class="required">*</span></label>
                                                                            </div>
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="text" id="diskon_persen" class="form-control percentage" onkeyup="hargakeyup()" name="diskon_persen" value="0" required>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 ">
                                                                                <input disabled type="text" id="diskon_rupiah" class="form-control numeric" onkeyup="discountnominal()" value="0" name="diskon_rupiah" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-4 controls">
                                                                                <input disabled type="text" id="Total" class="form-control numeric" name="Total" value="0" required readonly>
                                                                            </div>
                                                                        </div>
    ...
    <script>
        ...
        function AddtolistPPDetail() {
            if (document.getElementById("ppfaddtolistspan").innerText == "Add To List") {
                console.log("masuk");
                countRow = countRow + 1;
                var id, OP_duedate,pp_number,item_code,item_name,op_note,qty,harga,diskon_persen,diskon_rupiah,total;
                var trHTML = '';
                id = 0;
                var sumtotbarheader =0;
